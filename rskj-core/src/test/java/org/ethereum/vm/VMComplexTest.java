...
public class VMComplexTest {
    ...
    public void test1() {
        ...
        Address contractAddrB = new Address(contractAddr);
        Address callerAddrB = new Address(callerAddr);
    ...
    public void test2() {
        ...
        Address caller_addr = new Address(caller_addr_str);

        Address contractA_addr = new Address(contractA_addr_str);
        byte[] codeA = Hex.decode(code_a);

        Address contractB_addr = new Address(contractB_addr_str);
    ...
    public void test3() {
        ...
        // Set contract into Database
        Address caller_addr = new Address("cd2a3d9f938e13cd947ec05abc7fe734df8dd826");

        Address contractA_addr = new Address("77045e71a7a2c50903d88e564cd72fab11e82051");
        Address contractB_addr = new Address("83c5541a6c8d2dbad642f385d8d06ca9b6c731ee");
    ...
    public void test6() {
        ...
        // Set contract into Database
        Address caller_addr = new Address("cd1722f3947def4cf144679da39c4c32bdc35681");

        Address contractA_addr = new Address("945304eb96065b2a98b57a48a06ae28d285a71b5");
        Address contractB_addr = new Address("0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6");
