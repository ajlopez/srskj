...
public class MinerUtilsTest {
    ...
    public void getAllTransactionsTest() {
        ...
        Mockito.when(tx1.getSender()).thenReturn(new Address(addressBytes));
        Mockito.when(tx2.getSender()).thenReturn(new Address(addressBytes));
    ...
    public void validTransactionRepositoryNonceTest() {
        ...
        List<Transaction> txs = new LinkedList<>();
        txs.add(tx);
        Map<Address, BigInteger> accountNounces = new HashMap();
    ...
    public void invalidGasPriceTransactionTest() {
        ...
        Map<Address, BigInteger> accountNounces = new HashMap();
        byte[] addressBytes = ByteUtil.leftPadBytes(BigInteger.valueOf(new Random(0).nextLong()).toByteArray(), 20);
        accountNounces.put(new Address(addressBytes), BigInteger.valueOf(0));
        Repository repository = Mockito.mock(Repository.class);
    ...
    public void getAllTransactionsCheckOrderTest() {
        ...
        byte[] addressBytes = ByteUtil.leftPadBytes(BigInteger.valueOf(new Random(0).nextLong()).toByteArray(), 20);
        Mockito.when(tx0.getSender()).thenReturn(new Address(addressBytes));
        ...
        Mockito.when(tx3.getSender()).thenReturn(new Address(addressBytes));
