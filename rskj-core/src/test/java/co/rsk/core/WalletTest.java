...
public class WalletTest {
    ...
    public void addAccountWithPassphrase() {
        ...
        Account account = wallet.getAccount(new Address(address), "passphrase");
    ...
    public void addAccountWithPassphraseAndWithSeed() {
        ...
        Address addr1 = wallet.addAccount("passphrase");
    ...
    public void unlockAccountWithPassphrase() {
        ...
        Assert.assertTrue(wallet.unlockAccount(new Address(address), "passphrase"));

        Account account = wallet.getAccount(new Address(address));
    ...
    public void unlockNonexistentAccount() {
        ...
        Address addr = new Address("0x0000000000000000000000000000000000000023");
    ...
    public void lockAccount() {
        ...
        Assert.assertTrue(wallet.lockAccount(new Address(address)));

        Account account2 = wallet.getAccount(new Address(address));
